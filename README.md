...
This project now uses [Vite](https://vitejs.dev/) for development and production builds.
...
Locally preview the production build with Vite.
...
This project uses Vite environment files:
